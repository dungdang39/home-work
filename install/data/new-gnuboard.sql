...
CREATE TABLE IF NOT EXISTS `new_config` (
  ...
  `cf_1_subj` varchar(255) DEFAULT NULL COMMENT '여분필드1 제목',
  `cf_2_subj` varchar(255) DEFAULT NULL COMMENT '여분필드2 제목',
  `cf_3_subj` varchar(255) DEFAULT NULL COMMENT '여분필드3 제목',
  `cf_4_subj` varchar(255) DEFAULT NULL COMMENT '여분필드4 제목',
  `cf_5_subj` varchar(255) DEFAULT NULL COMMENT '여분필드5 제목',
  `cf_6_subj` varchar(255) DEFAULT NULL COMMENT '여분필드6 제목',
  `cf_7_subj` varchar(255) DEFAULT NULL COMMENT '여분필드7 제목',
  `cf_8_subj` varchar(255) DEFAULT NULL COMMENT '여분필드8 제목',
  `cf_9_subj` varchar(255) DEFAULT NULL COMMENT '여분필드9 제목',
  `cf_10_subj` varchar(255) DEFAULT NULL COMMENT '여분필드1 제목',
  `cf_1` varchar(255) DEFAULT NULL COMMENT '여분필드1',
  `cf_2` varchar(255) DEFAULT NULL COMMENT '여분필드2',
  `cf_3` varchar(255) DEFAULT NULL COMMENT '여분필드3',
  `cf_4` varchar(255) DEFAULT NULL COMMENT '여분필드4',
  `cf_5` varchar(255) DEFAULT NULL COMMENT '여분필드5',
  `cf_6` varchar(255) DEFAULT NULL COMMENT '여분필드6',
  `cf_7` varchar(255) DEFAULT NULL COMMENT '여분필드7',
  `cf_8` varchar(255) DEFAULT NULL COMMENT '여분필드8',
  `cf_9` varchar(255) DEFAULT NULL COMMENT '여분필드9',
  `cf_10` varchar(255) DEFAULT NULL COMMENT '여분필드10',
  PRIMARY KEY (`cf_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `new_member` (
  ...
  `mb_1` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 1',
  `mb_2` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 2',
  `mb_3` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 3',
  `mb_4` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 4',
  `mb_5` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 5',
  `mb_6` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 6',
  `mb_7` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 7',
  `mb_8` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 8',
  `mb_9` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 9',
  `mb_10` varchar(255) NOT NULL DEFAULT '' COMMENT '여분필드 10',
