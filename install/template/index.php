<?php $this->layout('_layout', ['title' => $version . " 라이센스 확인 1/3"]) ?>

<form action="./install_form.php" method="post" onsubmit="return frm_submit(this);">
    <div class="ins_inner">
        <p>
        ...
        <div class="ins_ta ins_license">
            <textarea name="textarea" id="ins_license" readonly><?=$this->e($license)?></textarea>
        </div>
