...
// 회원이미지 경로
$mb_img_path = G5_DATA_PATH.'/member_image/'.substr($member['mb_id'],0,2).'/'.get_mb_image_name($member['mb_id']).'.gif';
...
$mb_img_url  = G5_DATA_URL.'/member_image/'.substr($member['mb_id'],0,2).'/'.get_mb_image_name($member['mb_id']).'.gif'.$mb_img_filemtile;
